...
class TvDetailNotifier extends ChangeNotifier {
  ...
  TvDetail? _tvDetail;
  TvDetail? get tvDetail => this._tvDetail;

  RequestState _tvDetailState = RequestState.Empty;
  RequestState get tvDetailState => this._tvDetailState;

  List<Tv> _tvRecommendation = [];
  List<Tv> get tvRecommendation => this._tvRecommendation;

  RequestState _tvRecommendationState = RequestState.Empty;
  RequestState get tvRecommendationState => this._tvRecommendationState;
